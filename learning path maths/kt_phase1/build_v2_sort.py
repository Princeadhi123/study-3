"""Stage 2 (v2): external merge sort of kt_interactions_v2.csv.gz into
chronological (student_id, timestamp, attempt_number, preorder) order.
Same algorithm as legacy_v1_item_level/sort_phase1_kt.py, just pointed at the
v2 file (which has extra option/answer columns, carried through untouched)."""
import csv
import gzip
import heapq
import shutil
...
DATA = OUT / "data_v2"
SOURCE = DATA / "kt_interactions_v2.csv.gz"
SORTED = DATA / "kt_interactions_v2_sorted.csv.gz"
TEMP = OUT / "sort_chunks_v2"
CHUNK_SIZE = 250_000
